...
urlpatterns = [
     ...
     path('bookings/<int:booking_id>/add_room/',
          views.add_room, name='add_room'),
     path('rooms/<int:pk>/delete/',
          views.RoomDelete.as_view(), name='delete_room'),
     path('bookings/<int:booking_id>/assoc_cruise/<int:cruise_id>/',
          views.assoc_cruise, name='assoc_cruise'),
     path('bookings/<int:booking_id>/unassoc_cruise/<int:cruise_id>/',
          views.unassoc_cruise, name='unassoc_cruise'),
     path('bookings/<int:booking_id>/assoc_user/<int:user_id>/',
          views.assoc_user, name='assoc_user'),
     path('bookings/<int:booking_id>/unassoc_user/<int:user_id>/',
          views.unassoc_user, name='unassoc_user'),
     path('cruises/', views.cruises_index, name='cruises'),
     path('cruises/<int:cruise_id>/', views.cruise_detail, name='cruise_detail'),
     path('cruises/<int:cruise_id>/assoc_destination/<int:destination_id>/',
